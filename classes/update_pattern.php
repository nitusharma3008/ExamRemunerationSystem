...
?>
    ...
    <body>
        <div class="container mt-5">
            <h2>Exam Pattern Form</h2>
            <form action="/eduremun/classes/process_pattern.php?id=<?php echo $id; ?>" method="POST">
                <div class="form-group">
                    <label for="pattern">Pattern</label>
                    <input type="text" class="form-control" id="pattern" name="pattern"
                        value="<?php echo $read['pattern']; ?>" required>
                </div>
                <div class="form-group">
